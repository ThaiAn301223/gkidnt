...
class _AddProductScreenState extends State<AddProductScreen> {
  final _formKey = GlobalKey<FormState>(); // Tạo GlobalKey để quản lý trạng thái của form
  ...
  final List<String> _categories = ['Đồ ăn', 'Nước', 'Tráng miệng'];
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (widget.product != null) {
        FirebaseDatabase.instance
            ...
            .set(product.toJson()) // Sử dụng toJson
            .then((_) {
      ...
      _showSnackBar('Vui lòng điền đầy đủ thông tin!'); // Thông báo lỗi nếu form không hợp lệ
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.product != null ? 'Cập nhật sản phẩm' : 'Thêm sản phẩm'),
        centerTitle: true,
